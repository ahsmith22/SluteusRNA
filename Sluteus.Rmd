...
write.csv(lightgreenECrank, "modulesforGSEA/lightgreenECrank.csv") 
write.csv(magentaECrank, "modulesforGSEA/magentaECrank.csv") 
write.csv(greenECrank, "modulesforGSEA/greenECrank.csv") 
write.csv(blackECrank, "modulesforGSEA/blackECrank.csv") 
write.csv(midnightblueZnrank, "modulesforGSEA/midnightblueZnrank.csv") 
write.csv(turquoiseZnrank, "modulesforGSEA/turquoiseZnrank.csv") 
...
ECgenes <- read.csv("modulesforGSEA/midnightblueZnrank.csv", header = T)
...
write_csv(tabKS, "MFmidnightblue.csv")
...
head(forGSEAZn)
write.csv(forGSEAZn, "Zn_treatment_correlated_genes.csv") 
...
write.csv(forGSEAEC50, "EC50_correlated_genes.csv") 
